 ...
 * */
public class InstanceSelectedHAT extends HoeffdingAdaptiveTree{

	
	@Override
	public String getPurposeString() {
		return "Regularized HoeffdingAdaptiveTree for evolving data streams from xxxxxxxxxxxxxxxxxxxx.";
	}
